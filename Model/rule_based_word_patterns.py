...
dict.update({"however_p1": however_p1})
dict.update({"so_p1": so_p1})
dict.update({"now_p1": now_p1})
dict.update({"also_p1": also_p1})
dict.update({"but_p1": but_p1})
dict.update({"perhaps_p1": perhaps_p1})
dict.update({"or_p1": or_p1})
dict.update({"again_p1": again_p1})
dict.update({"greetings_p1": greetings_p1})
dict.update({"sometimes_p1": sometimes_p1})
dict.update({"finally_p1": finally_p1})
dict.update({"here_p1": here_p1})
