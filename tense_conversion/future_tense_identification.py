        ...
        for i in range(len(sent_list)):
            ...
            if sent_list[i][0] is not "#":
                ...
                if len(root_verb_index) != 0:
                    # check for the (dep_=nsubj or dep_=nsubjpass)combination out from the sent filtered out above   to get as the subject of the sentence
                ...
                if len(sub_index) != 0:
                    ...
                    dict.verb_sub_dict.update({i: [root_verb_index[0], sub_index[0]]})
                    # check for the (dep_=aux and tag_=MD combination out from the sent filtered out above  to get as the subject of the sentence
